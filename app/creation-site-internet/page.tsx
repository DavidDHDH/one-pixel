...
export default function CreationSiteInternetPage() {
  return (
    ...
    >
      <meta
        itemProp="name"
        content="Création de site internet à Saint-Barthélemy"
      />
      <meta
        itemProp="description"
        content="Création de sites internet professionnels et modernes à Saint-Barthélemy. Design unique, optimisation mobile et SEO local inclus."
      />
      <meta
        itemProp="url"
        content="https://one-pixel.com/creation-site-internet"
      />
